...
namespace Test_Assignment_3
{
    public class LinkedListTests
    {
        ...
        {
            User john = new User(1, "John", "something@gmail.com", "1234");
            User cathy = new User(2, "Cathy", "something@gmail.com", "1234");

			this.linkedList.Append("a");
			this.linkedList.Append(john);
			this.linkedList.Append("b");
			this.linkedList.Append("c");
			this.linkedList.Append("d");
            ...
            // Check if none of the nodes moved
			// Test the first node value is a
			Assert.AreEqual("a", this.linkedList.Retrieve(0));

            // Test the second node value is john
            Assert.AreEqual(john, this.linkedList.Retrieve(1));
            ...
            this.linkedList.Append(cathy);

            this.linkedList.Sort();

			// Test the size is 6
			Assert.AreEqual(6, this.linkedList.Size());

			// Check if the users are sorted
			// Test the first node value is a
			Assert.AreEqual("a", this.linkedList.Retrieve(0));

			// Test the second node value is cathy
			Assert.AreEqual(cathy, this.linkedList.Retrieve(1));
			...
			// Test the sixth node value is john
			Assert.AreEqual(john, this.linkedList.Retrieve(5));
        ...
        public void TestToArray()
        {
            ...
            object[] array = this.linkedList.ToArray();

            Assert.AreEqual(new string[] { "a", "b", "c", "d" }, array);
		}
    }
}
